...
function checkCards() {
  ...
  clickedBox = [];
  //  CONSOLE.LOG YOUR CODEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
  // USE BACKTICSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
}
...
function winningBoard() {
  ...
  if (faceGang === true) {
    document.querySelector("h2").innerText = "YOU WON A NEW LAMBORGHINI!!";
  } else {
    document.querySelector("h2").innerText = "KEEP TRYINGGGG!";
  }
